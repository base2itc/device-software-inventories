...
$vCenterServerIP = "vcenter01.intern.averdung.de"
$FirmenName = "Averdung*"
...
$Pass = ConvertTo-SecureString 'ah,M=X"=8|,^=pQ!2`1P' -asplaintext -force
...
C:\ProgramData\NinjaRMMAgent\ninjarmm-cli.exe set AverdungUmgebung  $Cloudvms "VMs," $CloudCPU "CPUs," $CloudRam "GB RAM," $CloudStorage "StorageGB,"
