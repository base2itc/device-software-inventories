...
$vCenterServerIP = "vcenter.wgd.local"
$FirmenName = "WGD*"
...
$Pass = ConvertTo-SecureString "G,D+r=xL0u30m0?lQ't1" -asplaintext -force
...
C:\ProgramData\NinjaRMMAgent\ninjarmm-cli.exe set WilhelmUmgebung  $Cloudvms "VMs," $CloudCPU "CPUs," $CloudRam "GB RAM," $CloudStorage "StorageGB,"
