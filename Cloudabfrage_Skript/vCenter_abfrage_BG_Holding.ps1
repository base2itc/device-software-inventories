...
$vCenterServerIP = "vcenter02.ggpro.de"
$FirmenName = "BG*"
...
$Pass = ConvertTo-SecureString 'PKUvTc5Ez8HPpVMware!' -asplaintext -force
...
C:\ProgramData\NinjaRMMAgent\ninjarmm-cli.exe set BGUmgebung  $Cloudvms "VMs," $CloudCPU "CPUs," $CloudRam "GB RAM," $CloudStorage "StorageGB,"
