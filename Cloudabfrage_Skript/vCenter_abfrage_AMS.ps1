...
$vCenterServerIP = "vcsa01.ams.local"
$FirmenName = "AMS*"
...
$Pass = ConvertTo-SecureString 'HcD$pdPUQm77#pAf1Q' -asplaintext -force
...
C:\ProgramData\NinjaRMMAgent\ninjarmm-cli.exe set AMSUmgebung  $Cloudvms "VMs," $CloudCPU "CPUs," $CloudRam "GB RAM," $CloudStorage "StorageGB,"
