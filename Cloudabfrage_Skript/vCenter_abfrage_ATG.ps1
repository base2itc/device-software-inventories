...
$vCenterServerIP = "vcenter01.atg.local"
$FirmenName = "ATG*"
...
$Pass = ConvertTo-SecureString 'jm34AC9d#vmware&' -asplaintext -force
...
C:\ProgramData\NinjaRMMAgent\ninjarmm-cli.exe set ATGUmgebung  $Cloudvms "VMs," $CloudCPU "CPUs," $CloudRam "GB RAM," $CloudStorage "StorageGB,"
