...
$vCenterServerIP = "vcenter01.maler.local"
$FirmenName = "Hubert*"
...
$Pass = ConvertTo-SecureString 'XnFC_y8f$sFnkh8' -asplaintext -force
...
C:\ProgramData\NinjaRMMAgent\ninjarmm-cli.exe set HubertUmgebung  $Cloudvms "VMs," $CloudCPU "CPUs," $CloudRam "GB RAM," $CloudStorage "StorageGB,"
